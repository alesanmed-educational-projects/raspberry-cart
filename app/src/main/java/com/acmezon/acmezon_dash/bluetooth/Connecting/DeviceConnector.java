...
public class DeviceConnector {
    ...
    private synchronized void setState(int state) {
        ...
        //mHandler.obtainMessage(Messages.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
    }
    // ==========================================================================
    ...
    public synchronized void connected(BluetoothSocket socket) {
        ...
        mHandler.onDeviceName(deviceName);
        //Message msg = mHandler.obtainMessage(Messages.MESSAGE_DEVICE_NAME, deviceName);
    ...
    private class ConnectedThread extends Thread {
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    if (readed.contains("\n")) {
                        mHandler.onMessageRead(bytes, readMessage.toString());
                        //mHandler.obtainMessage(Messages.MESSAGE_READ, bytes, -1, readMessage.toString()).sendToTarget();
        ...
        public void writeData(byte[] chunk) {
            ...
            try {
                ...
                mHandler.onMessageWritten(chunk);
                // Share the sent message back to the UI Activity
                //mHandler.obtainMessage(Messages.MESSAGE_WRITE, -1, -1, chunk).sendToTarget();
            } catch (IOException e) {
